...
var endGame = function() {
        ...
        if (playerInfo.money > highScore) {
            ...
            alert(playerInfo.name + " did not beat the high score of " + highScore + ". xd get good!")
        }
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one 1 for REFILL, 2 for UPGRADE, or 3 for LEAVE.(All shop options cost $7)"
    )
